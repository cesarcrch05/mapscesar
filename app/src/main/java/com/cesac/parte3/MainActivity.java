...
// Obtenemos el mapa de forma asíncrona (notificará cuando esté listo)
    ...
    public void onMapReady(GoogleMap googleMap) {
        mapa = googleMap;
        ubicacion = new LatLng(-5.175456091612489, -80.68676231639142); //Nos ubicamos en la UNJBG
        mapa.addMarker(new MarkerOptions().position(ubicacion).title("Marcador"));
